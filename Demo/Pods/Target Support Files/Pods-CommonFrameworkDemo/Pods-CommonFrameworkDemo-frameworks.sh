...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/CYCommonFramework/CYCommonFramework.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CYWebViewProgressView/CYWebViewProgressView.framework"
